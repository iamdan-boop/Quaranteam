    ...
    <div id="page-content-wrapper">
        <div>
            ...
            <div class="container-md d-flex justify-content-center announceTitle">
                <h3 class="mt-3"><b>My Schedules</b></h3>
            </div>
                    ...
                    <tbody>
                        @foreach ($appointments as $appointment)
                            <tr class="border-bottom">
                                ...
                                <td>
                                    <a href="{{ route('resident.view-booking.schedules', ['id' => $appointment]) }}"
                                        class="btn btn-success" style="background-color: #5bacaf;">View Details</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
